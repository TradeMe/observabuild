...
const { Build, check, log, parallel, serial, step, yarn } = require('../lib'); // require('@trademe/observabuild');
    ...
    .start(
        ...
        parallel(
            ...
            serial(
                ...
                step(task => 'task after delay', { statusMessage: { start: 'start after two', success: 'two finished' }, prefix: 'Two', flowId: 'tcTwo' })
            ),
            check(state => !state.failBuild,
